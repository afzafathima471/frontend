...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (username === "admin" && password === "admin123") {
      ...
      localStorage.setItem("name", "Employee User");
      router.push("/"); 
    } else {
...
const containerStyle: React.CSSProperties = {
  ...
  display: "flex",
  alignItems: "center",
  justifyContent: "flex-end", // Card ko right side par push karne ke liye
  paddingRight: "10%", // Right side se gap
  backgroundImage: "url('/login-bg.png')", // Aapki PNG image yahan se load hogi
...
const glassCard: React.CSSProperties = {
  ...
  boxShadow: "0 25px 60px rgba(0, 0, 0, 0.93)",
  zIndex: 10,
  color: "#ffffffee"
};
...
const errorBox: React.CSSProperties = { 
  ...
  borderRadius: "10px", fontSize: "14px", textAlign: "center", marginBottom: "20px", border: "1px solid rgba(255, 77, 77, 0.2)" 
};
